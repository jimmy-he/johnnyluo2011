...
public class ChineseConvertor {
	...
	public static void main(String[] args) throws Exception{
		...
		byte[] uniCode = new String("啊").getBytes("gb2312");
		
		String str = null;
		str = "谢海101普降喜雨";
		System.out.println("Spell=" + ChineseConvertor.getFirstSpell(str));

		str = "张牙舞爪》。、";
		System.out.println("Spell=" + ChineseConvertor.getFullSpell(str));
