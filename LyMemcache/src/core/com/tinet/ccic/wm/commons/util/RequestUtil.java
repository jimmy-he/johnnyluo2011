...
public class RequestUtil {
	 ...
	 * @return Long[]
	 * 
	 * @see RequestUtil#getLongArray(String)
	 */
	 ...
	 * @param delim 分割符
	 * @return
	 * @see RequestUtil#getLongArray(String, String)
	 */
	 ...
	 * @param format 格式字符串，{@link DateUtil#FMT_DATE_YYYY_MM_DD}等。
	 * @return
	 * @see RequestUtil#getDate(String, Date, String)
	 */
	 ...
	 * @param s 源文。
	 * @return 编码后的码文。
	 * @see RequestUtil#encodeUrl(String)
	 */
