 ...
 * @author 王永明
 * @since Apr 7, 2010 10:04:35 AM
 */
public class CronExpression {
	private String expression;
	
	/**每秒执行一次*/
	public static final CronExpression PER_SECOND=new CronExpression("0/1 * * * * ?");
	/**每十秒执行一次*/
	public static final CronExpression TEN_SECOND=new CronExpression("0/10 * * * * ?");
